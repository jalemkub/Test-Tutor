...
# Check Success
#     [Arguments]  ${row}
#     ${status}  ${text}=    Run Keyword And Ignore Error  Execute Javascript    return document.querySelector(${success_form}).innerHTML;
#     # เขียนข้อความลง Excel
#     Run Keyword If  '${status}' == 'PASS'  Write Excel Cell    ${row}    6    ${text}
